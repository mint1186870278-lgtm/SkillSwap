...
export function seedDatabase() {
  ...
  const seed = db.transaction(() => {
    ...
    const skills = [
      ...
      [4, 'Yoga for Beginners', 'Mike Chen', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=150&q=80', 'Fitness', '1.2km', 'https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?auto=format&fit=crop&w=600&q=80', 4.9, 560, 'Chinese', 1, 'Hatha Yoga certified. Gentle introduction to basic poses, breathing techniques, and mindfulness.'],
      ...
      [6, 'Guitar Basics', 'Alex Turner', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80', 'Music', '4.5km', 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?auto=format&fit=crop&w=600&q=80', 4.8, 210, 'English', 2, 'Acoustic guitar fundamentals. Chords, strumming patterns, and reading tabs. Fun and relaxed atmosphere.'],
      [7, 'Watercolor Painting', 'Anna Li', 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=150&q=80', 'Art', '1.5km', 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&w=600&q=80', 4.9, 150, 'Chinese', 2, 'Express yourself through watercolors. Techniques for landscapes, florals, and abstract art.'],
      [8, 'Python Data Science', 'James O.', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80', 'Tech', 'Online', 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=600&q=80', 5.0, 800, 'English', 4, 'Data analysis with Pandas, visualization with Matplotlib, and intro to Machine Learning.'],
      [9, 'Vegan Cooking', 'Linda Green', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80', 'Cooking', '2.0km', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=600&q=80', 4.6, 90, 'English', 1, 'Delicious plant-based recipes that are easy to make and packed with nutrition.'],
      ...
      [12, 'French for Travel', 'Sophie Marceau', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80', 'Language', 'Online', 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=600&q=80', 4.7, 180, 'French', 2, 'Essential phrases and cultural tips for your trip to France. Order food, ask directions, and more.'],
      [13, 'Ceramics Workshop', 'Pat M.', 'https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=150&q=80', 'Art', '3.5km', 'https://images.unsplash.com/photo-1610701596007-11502861dcfa?auto=format&fit=crop&w=600&q=80', 4.9, 220, 'English', 2, 'Hand-building and wheel throwing techniques. Glazing and firing. All levels welcome.'],
      ...
      [15, 'Mixology 101', 'Barney S.', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80', 'Cooking', '1.0km', 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=600&q=80', 4.8, 150, 'English', 2, 'Craft classic cocktails like a pro. Learn about spirits, mixers, and garnishes.'],
    ];
    ...
    const sessions = [
      [1, 'upcoming', 'Spanish Conversation', null, 'Elena Rodriguez', null, 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80', 'Today', '14:00 - 15:00', 'Confirmed', '#', null, 0, null],
      ...
      [3, 'pending', 'Photography Basics', null, 'Sarah Jenks', null, 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150&q=80', 'Feb 12, 2026', '16:30 - 17:30', 'Waiting for acceptance', null, null, 0, null],
      ...
      [5, 'past', 'Guitar Basics', null, 'Alex Turner', null, 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80', 'Jan 28, 2026', '18:00 - 19:00', 'Completed', null, null, 0, null],
    ...
    // --- Contacts ---
    const contacts = [
      [1, 'Elena Rodriguez', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80', 'Hola! Are we still on for tomorrow?', '2m', 2, 'online', 'Spanish Conversation'],
      [2, 'David Kim', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80', 'I sent you the project files.', '1h', 0, 'offline', 'React Mentorship'],
      [3, 'Sarah Jenks', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150&q=80', 'Thanks for the pottery tips!', '1d', 0, 'online', 'Pottery Basics'],
    ];
    ...
    const messages = [
      [1, 1, 'them', 'Hola Jessica! I noticed you are interested in improving your Spanish conversation skills.', '10:30 AM', 'text', null, null, null, null, null],
      [2, 1, 'me', 'Hi Elena! Yes, I learned some basics in college but I need practice speaking.', '10:32 AM', 'text', null, null, null, null, null],
      ...
      [4, 1, 'system', 'Translation: \u5b8c\u7f8e\uff01\u6211\u5f88\u4e50\u610f\u5e2e\u52a9\u4f60\u3002\u6211\u6b63\u5728\u627e\u4eba\u5e2e\u6211\u89e3\u51b3 Figma \u81ea\u52a8\u5e03\u5c40\u7684\u95ee\u9898\u3002', null, 'ai_trans', null, null, null, null, 'Globe'],
      [5, 1, 'me', 'That sounds like a great match! I use Figma every day.', '10:34 AM', 'text', null, null, null, null, null],
      [6, 1, 'me', 'How about we do a 1-hour session? 30 mins Spanish, 30 mins Figma.', '10:35 AM', 'text', null, null, null, null, null],
      [7, 1, 'them', 'Sounds fair. When are you free?', '10:36 AM', 'text', null, null, null, null, null],
      [8, 1, 'me', null, null, 'proposal', 'pending', 'Figma Tips', 'Spanish Practice', 'Tomorrow, 2:00 PM', null],
    ];
    ...
    // --- Posts ---
    const posts = [
      [1, 'Finally baked my first perfect sourdough! \ud83c\udf5e\u2728', null, 'Emma Wilson', 'https://images.unsplash.com/photo-1558898479-33c0057a5d12?auto=format&fit=crop&w=150&q=80', 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?auto=format&fit=crop&w=600&q=80', 124, 0, 'Baking', null],
      [2, 'Sketching session at the park today. Anyone want to join next time?', null, 'Sarah Jenks', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150&q=80', 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?auto=format&fit=crop&w=600&q=80', 89, 0, 'Art', null],
      [3, 'My pottery progress after 3 weeks with @MikeChen. \ud83c\udff0', null, 'Jessica L.', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80', 'https://images.unsplash.com/photo-1493106641515-6b5631de4bb9?auto=format&fit=crop&w=600&q=80', 256, 0, 'Ceramics', null],
      [4, 'Coding setup upgrade! Ready to teach React.', null, 'David Kim', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80', 'https://images.unsplash.com/photo-1587620962725-abab7fe55159?auto=format&fit=crop&w=600&q=80', 412, 0, 'Tech', null],
      ...
      [7, 'Urban gardening in my tiny apartment \ud83c\udf31', null, 'Green Thumb', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80', 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?auto=format&fit=crop&w=600&q=80', 156, 0, 'Gardening', null],
      ...
      [9, 'Exploring the hidden gems of Kyoto \ud83c\uddef\ud83c\uddf5', null, 'Travel Bug', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80', 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=600&q=80', 340, 0, 'Travel', null],
      [10, 'DIY shelf project finally complete! \ud83d\udd28', null, 'Maker Joe', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80', 'https://images.unsplash.com/photo-1512418490979-92798cec1380?auto=format&fit=crop&w=600&q=80', 210, 0, 'DIY', null],
      ...
      [12, 'Abstract painting sunday \ud83c\udfa8', null, 'Art Vibe', 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=150&q=80', 'https://images.unsplash.com/photo-1547891654-e66ed7ebb968?auto=format&fit=crop&w=600&q=80', 115, 0, 'Art', null],
    ...
    const communityUpdates = [
      [1, 'Sophie just learned Python from Mark!', '2m ago', '\ud83d\ude80', 'bg-blue-100 text-blue-600'],
      [2, "New 'Watercolor' group in Downtown.", '15m ago', '\ud83c\udfa8', 'bg-purple-100 text-purple-600'],
      ...
      [8, 'Anna swapped skills with Robert.', '6h ago', 'qh', 'bg-teal-100 text-teal-600'],
    ...
    const userPosts = [
      [1, 'u_jessica', "Just finished a wonderful pottery session with @Sarah! \ud83c\udff0 Can't wait to show you all the final glazing results next week.", 'https://images.unsplash.com/photo-1493106641515-6b5631de4bb9?auto=format&fit=crop&w=600&q=80', 124, 18, '2h ago'],
      [2, 'u_jessica', "Sharing my top 5 Figma plugins for 2026. Check the thread! \ud83d\udc47 #DesignTips", null, 89, 42, '1d ago'],
    ];
    ...
    // --- Reviews ---
    const reviews = [
      ['Sarah Jenks', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150&q=80', 5, '2 days ago', 'Jessica is an amazing teacher! She explained auto-layout in Figma so clearly. I finally understand how it works. Highly recommend!', 'Figma Mastery'],
      ['Mike Chen', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=150&q=80', 5, '1 week ago', "Had a great pottery session. She was very patient with my clumsy hands lol. Can't wait for the next lesson.", 'Pottery Basics'],
      ['Elena Rodriguez', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80', 5, '2 weeks ago', 'Very professional and friendly. We exchanged Spanish for Figma tips, and it was a perfect swap.', 'Skill Swap'],
