...
const ProductPreview: React.FC = () => {
  ...
  const steps = [
    { title: t('product_preview.steps.0.title'), desc: t('product_preview.steps.0.desc') },
    { title: t('product_preview.steps.1.title'), desc: t('product_preview.steps.1.desc') },
    { title: t('product_preview.steps.2.title'), desc: t('product_preview.steps.2.desc') }
  ];
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-16">
          ...
          <div className="flex-1 max-w-lg">
             <div className="inline-block px-4 py-1 rounded-full bg-pastelYellow/50 border border-pastelYellow text-yellow-700 font-bold text-xs uppercase tracking-wider mb-6">
                {t('product_preview.tag')}
             </div>
             <h2 className="text-4xl md:text-6xl font-black text-textMain mb-8 font-heading leading-tight">
                {t('product_preview.title_prefix')} <br/> <span className="text-purple-500">{t('product_preview.title_suffix')}</span>
             </h2>
          ...
          <div className="relative">
             ...
             <div className="relative w-[320px] h-[640px] bg-white/40 backdrop-blur-2xl border border-white/60 rounded-[3rem] shadow-glass p-4 overflow-hidden">
                 ...
                 <div className="bg-white/60 rounded-[2rem] p-6 mb-4 text-center shadow-sm">
                     <div className="text-xs font-bold text-textLight uppercase mb-1">{t('product_preview.phone.insight')}</div>
                     <h3 className="text-xl font-bold text-textMain mb-4">{t('product_preview.phone.question')}</h3>
                     ...
                     <div className="bg-textMain text-white rounded-full py-2 px-4 text-sm font-bold shadow-lg">
                        {t('product_preview.phone.action')}
                     </div>
                 </div>
                 ...
                 <div className="grid grid-cols-2 gap-3 mb-4">
                    <div className="bg-pastelGreen/40 p-4 rounded-[2rem]">
                        ...
                        <div className="text-xs text-textMain opacity-60">{t('product_preview.phone.streak')}</div>
                    </div>
                    <div className="bg-pastelYellow/40 p-4 rounded-[2rem]">
                        <div className="text-2xl mb-1">⭐</div>
                        <div className="font-bold text-textMain">Level 5</div>
                        <div className="text-xs text-textMain opacity-60">{t('product_preview.phone.explorer')}</div>
                    </div>
                 </div>
                 ...
                 <div className="space-y-2">
                    <div className="bg-white/50 p-3 rounded-[1.5rem] flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            <div className="font-bold text-sm text-textMain">{t('product_preview.phone.lesson')}</div>
