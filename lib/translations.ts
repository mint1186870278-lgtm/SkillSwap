...
export const translations = {
  en: {
    ...
    explore: {
      ...
      forum: "Forum",
      exchange_feedback: "Exchange Feedback",
      all_posts: "All Posts",
      ...
      ai_loading: "Matching...",
      ai_hero_title: "Can't find a match? Let AI find your skill swap partner",
      ai_hero_subtitle: "Describe what you can teach and what you want to learn—AI will match you with partners for mutual exchange."
    },
    exchange: {
      title: "My Exchanges",
    ...
    messages: {
      ...
      empty_text: "Start exploring skills and find someone to swap with! Your first exchange could be just a tap away.",
      empty_btn: "Find Skill Partners",
      ...
      tomorrow: "Tomorrow",
      drafting: "Drafting",
      exchange_progress: "Exchange Progress",
    ...
    exchange_feedback: {
      ...
      auto_created: "Auto-created when you confirm a swap",
    ...
    skill_detail: {
      back: "Back",
      teacher_profile: "Skill Profile",
      students: "Exchanges",
      lessons: "Lessons",
      attendance: "Attendance",
      about_me: "About Me",
      as_teacher: "My Skills",
      my_lessons: "My Lessons",
      availability: "Availability",
      available: "Available",
      view_schedule: "View Full Schedule",
      similar_experts: "Similar Skill Partners",
      find_more: "Find more partners",
      request_swap: "Request Swap",
      contact_teacher: "Contact to Swap",
      ...
      swap_ways: "Exchange Options",
      they_offer: "They offer",
      they_want_to_learn: "They want to learn",
      exchange_formats: "Exchange formats",
      propose_swap: "Propose an exchange",
      package_off: "Package 10% OFF",
      ai_credibility: "AI Credibility Score",
      ai_credibility_desc: "Based on sustained content sharing in this domain",
      ai_credibility_source: "From Bilibili 12 posts",
      view_their_nfts: "View their NFT Showcase",
      mutual_reviews: "Mutual Reviews",
      review_from: "→",
      swap_with: "swap with"
    },
    social_auth: {
      title: "Social Accounts",
      subtitle: "Authorize to boost your credibility",
      connect: "Connect",
      connected: "Connected",
      bilibili: "Bilibili",
    ...
    nft_showcase: {
      title: "NFT Showcase",
      subtitle: "Skill swap certificates",
      view_all: "View All",
      contribution: "Contribution",
      story: "Swap Story",
      timeline: "Timeline",
      my_contribution: "contribution",
      partner_contribution: "contribution",
  ...
  zh: {
    ...
    explore: {
      ...
      ai_hero_title: "没找到合适的？让 AI 帮你精准匹配技能伙伴",
      ai_hero_subtitle: "描述你擅长什么、想学什么，AI 会为你找到能互相交换的伙伴。"
    },
    exchange: {
      title: "我的交换",
    ...
    messages: {
      ...
      search: "搜索聊天...",
      empty_title: "还没有聊天",
      empty_text: "去发现页找找看，说不定你的第一个技能交换伙伴就在那里！",
      empty_btn: "去发现技能伙伴",
      ai_translate: "AI 翻译",
      suggest_time: "建议时间",
      draft_contract: "起草合同",
      ...
      tomorrow: "明天",
      drafting: "起草中",
      exchange_progress: "交换进度",
      stage_progress: "阶段",
      achievement_unlocked: "已点亮",
      achievement_locked: "未点亮"
    },
    exchange_feedback: {
      title: "交换反馈",
      auto_created: "双方确认交换后平台自动创建",
      progress_updates: "学习进度",
      add_progress: "记录进度"
    },
    profile: {
      pro: "Pro",
      ...
      edit_skills: "编辑",
      i_can_teach: "我会的",
      i_want_to_learn: "我想学的"
    },
    skill_detail: {
      back: "返回",
      teacher_profile: "技能主页",
      students: "交换次数",
      lessons: "课程",
      attendance: "出勤率",
      about_me: "关于我",
      ...
      similar_experts: "相似技能伙伴",
      find_more: "寻找更多",
      request_swap: "请求交换",
      contact_teacher: "联系交换",
      response_time: "响应时间",
      ...
      swap_ways: "交换方式",
      they_offer: "TA 擅长",
      they_want_to_learn: "TA 想学",
      exchange_formats: "可交换形式",
      propose_swap: "发起交换",
      package_off: "套餐 10% 优惠",
      ai_credibility: "AI 可信度评分",
      ai_credibility_desc: "基于该领域持续内容分享",
      ai_credibility_source: "来自哔哩哔哩 12 篇分享",
      view_their_nfts: "查看 TA 的交换 NFT",
      mutual_reviews: "交换互评",
      review_from: "→",
      swap_with: "与"
    },
    ...
    nft_showcase: {
      ...
      timeline: "时间线",
      my_contribution: "的贡献",
      partner_contribution: "的贡献",
      your_contribution: "我的贡献"
    },
    modal: {
      follow: "关注",
      posted_on: "发布于",
