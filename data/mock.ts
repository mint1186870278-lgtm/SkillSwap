...
import { Skill, Post, Session, Contact, Message, CommunityUpdate, Review } from '../types';
...
export const CONTACTS: Contact[] = [
  { id: 1, name: 'Elena Rodriguez', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80', lastMsg: 'Hola! Are we still on for tomorrow?', time: '2m', unread: 2, status: 'online', skill: 'Spanish Conversation' },
  { id: 2, name: 'David Kim', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80', lastMsg: 'I sent you the project files.', time: '1h', unread: 0, status: 'offline', skill: 'React Mentorship' },
  { id: 3, name: 'Sarah Jenks', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150&q=80', lastMsg: 'Thanks for the pottery tips!', time: '1d', unread: 0, status: 'online', skill: 'Pottery Basics' },
];

export const MESSAGES: Message[] = [
  { id: 1, sender: 'them', text: 'Hola Jessica! I noticed you are interested in improving your Spanish conversation skills.', time: '10:30 AM' },
  { id: 2, sender: 'me', text: 'Hi Elena! Yes, I learned some basics in college but I need practice speaking.', time: '10:32 AM' },
  { id: 3, sender: 'them', text: 'Perfect! I would love to help you. I am looking for someone to help me with Figma auto-layout.', time: '10:33 AM' },
  { id: 4, sender: 'system', type: 'ai_trans', text: 'Translation: 完美！我很乐意帮助你。我正在找人帮我解决 Figma 自动布局的问题。', icon: Globe },
  { id: 5, sender: 'me', text: 'That sounds like a great match! I use Figma every day.', time: '10:34 AM' },
  { id: 6, sender: 'me', text: 'How about we do a 1-hour session? 30 mins Spanish, 30 mins Figma.', time: '10:35 AM' },
  { id: 7, sender: 'them', text: 'Sounds fair. When are you free?', time: '10:36 AM' },
  { id: 8, sender: 'me', type: 'proposal', status: 'pending', skill_me: 'Figma Tips', skill_them: 'Spanish Practice', time_slot: 'Tomorrow, 2:00 PM' },
];
...
export const MOCK_USER_POSTS: Post[] = [
  { 
    id: 1, 
    content: "Just finished a wonderful pottery session with @Sarah! 🏺 Can't wait to show you all the final glazing results next week.", 
    image: "https://images.unsplash.com/photo-1493106641515-6b5631de4bb9?auto=format&fit=crop&w=600&q=80",
    likes: 124, 
    comments: 18,
    time: "2h ago",
    user: 'Jessica Parker',
  ...
  { 
    id: 2, 
    content: "Sharing my top 5 Figma plugins for 2026. Check the thread! 👇 #DesignTips", 
    image: null,
    likes: 89, 
    comments: 42,
    time: "1d ago",
...
// --- SKILL DETAIL VIEW DATA ---

export const SIMILAR_EXPERTS: any[] = [
